  ...
  return (
    <section className="services" id="services">
      <div className="section-head">
        ...
        <h2 className="big-heading reveal-on-scroll">
      ...
      <div className="services-grid">
        <article className="svc" data-cursor="card">
          ...
          <p className="svc-desc">
            Positioning, naming, visual identity, and the systems that scale them
        ...
        <article className="svc" data-cursor="card">
          ...
          <p className="svc-desc">
            Marketing sites that load fast, convert, and feel inevitable. From
            sitemap to launch.
          </p>
          <ul className="svc-list">
        ...
        <article className="svc" data-cursor="card">
          ...
          <p className="svc-desc">
            Webflow, headless, Next.js, custom CMS - pick a stack, we&apos;ll
            ship it without compromise.
          </p>
          <ul className="svc-list">
            <li>Webflow & CMS</li>
            <li>Next.js / Astro</li>
          ...
          <div className="svc-art">
            <div className="art-code">
              <span>{"{ "}</span>
              <span className="c-tag">design</span>
              <span>{": "}</span>
              <span className="c-str">&quot;engineering&quot;</span>
              <span>{" }"}</span>
            </div>
          </div>
        </article>
        ...
        <article className="svc" data-cursor="card">
          ...
          <p className="svc-desc">
            Dashboards, onboarding, and complex flows for early-stage products
            that need to feel obvious.
          </p>
          <ul className="svc-list">
        ...
        <article className="svc" data-cursor="card">
          ...
          <p className="svc-desc">
            Hero animations, scroll narratives, and lightweight 3D - built
        ...
        <article className="svc" data-cursor="card">
          ...
          <p className="svc-desc">
            Most projects don&apos;t end at launch. Retainers for iteration,
            A/B, and content velocity.
          </p>
          <ul className="svc-list">
